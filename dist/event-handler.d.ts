...
declare class EventHandler<M extends EventHandlerDataMap = EventHandlerDataMap> {
     ...
     */
    addEventListener<T extends string = string, U extends M[T] = M[T], V extends this = this>(type: T, listener: EventHandlerListener<U, T, V>, options?: EventHandlerOptions<U>): boolean;
    /**
     * Remove the listener.
     * @param type This represents the name of the event.
     ...
     */
    dispatchEvent<T extends string>(type: T, data?: M[T]): Promise<void>;
}
